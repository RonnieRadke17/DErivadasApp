...
public class MainActivity extends AppCompatActivity {//revisar lo de la potencia
    ...
    public boolean regla4(String valor){//puros numeeros -1 1 1/1 0.4 -4.0 etc
        String valorFinal = "";
        boolean regla = false;
        for (int i = 0; i < valor.length(); i++) {
            char letra = valor.charAt(i);
            //poner que evalue antes de un numero si hay un signo de potencia ^
            if(valor.charAt(0) != 'x' || valor.charAt(0) != '-' || valor.charAt(1) != 'x' ){
                regla = false;
                break;
            }else{
                if (letra == '1' || letra == '2' || letra == '3' || letra == '4' || letra == '5' || letra == '6' || letra == '7' || letra == '8' || letra == '9' || letra == '0' || letra == 'x' || letra == '/' || letra == '.' || letra == '^' || letra == '√') {
                    //valorFinal += letra;
                    regla = true;
                    //Toast.makeText(this,"regla 1:"+valor,Toast.LENGTH_SHORT).show();
                }else {
    ...
    public boolean regla5(String valor){//puros numeeros -1 1 1/1 0.4 -4.0 etc
        ...
        for (int i = 0; i < valor.length(); i++) {
            ...
            if (letra == '-' || letra == '1' || letra == '2' || letra == '3' || letra == '4' || letra == '5' || letra == '6' || letra == '7' || letra == '8' || letra == '9' || letra == '0' || letra == 'x' || letra == '/' || letra == '.' || letra == '^' || letra == '√') {
                //valorFinal += letra;
                regla = true;
                //Toast.makeText(this,"regla 1:"+valor,Toast.LENGTH_SHORT).show();
            }else {
